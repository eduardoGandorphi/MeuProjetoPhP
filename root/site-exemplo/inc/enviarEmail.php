...
define('GPWD', '@Envio2o19');		// <-- Insira aqui a senha do seu GMail

function enviarEmail($para, $de, $de_nome, $assunto, $corpo) { 
	global $error;
	$mail = new PHPMailer();
	$mail->IsSMTP();	// Ativar SMTP
	$mail->SMTPDebug = 1;// Debugar: 1=erros/mensagens, 2=mensagens apenas
	...
	$mail->SetFrom(GUSER, 'Remetente');//Remetente
